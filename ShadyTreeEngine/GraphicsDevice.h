...
public:
    ...
    virtual void Draw(BufferHandle& hMesh, TextureHandle& hTex) = 0;
    virtual void EndDraw() = 0;
    virtual void PresentFrame() = 0;
    virtual void Free() = 0;

    virtual int createVertexIndexBuffer(std::string name, Vertex* vertices, int vertexCount, unsigned int* indices, int numIndices, BufferHandle* handle) = 0;
